    ...
    install(Vue){
            ...
            Vue.prototype.initilize = function(opt){
                ...
                this.cropper = new Cropper(this.preview,{
                    aspectRatio : opt.aspectRatio ? opt.aspectRatio : 1, // 设置裁剪器的比例
                    viewMode : 1, // 显示
                    background : false,
                    zoomable : false,
                    center : false
            ...
            Vue.prototype.createElement = function(){
                ...
                let str = `<div><img id="clip_image" src="originUrl"></div>
                    <button type="button" id="cancel_clip">取消</button>
                    <button type="button" id="clip_button">确定</button>`;
                    str += `<div class="crop_loading">
                                <div class="crop_content">
                                    <img src="../static/loading.gif">
                                    <div class="crop_text">图片上传中</div>
                                </div>
                            </div>`;
                    str += `<div class="crop_success">
                                <div class="crop_success_text">上传成功</div>
                            </div>`;
            ...
            Vue.prototype.crop = function(){
                ...
                let imgData = roundedCanvas.toDataURL(); // 转化成一个url
            ...
            Vue.prototype.getRoundedCanvas = function(sourceCanvas){
                ...
                context.imageSmoothingEnabled = true; // 图片平滑
            ...
            Vue.prototype.postImg = function(){
                let self = this;
                var suc = document.querySelector('.crop_success');
            ...
            Vue.prototype.compress = function(img,Orientation){
                ...
                if ((count = width * height / 1000000) > 1){ 
                    //计算要分成多少块瓦片 Math.sqrt开平方根  ~~类型转换 转换成数字
                    ...
                    for(let i=0;i<count;i++){
                        for(let j=0;j<count;j++){
                            ...
                            tctx.drawImage(tCanvas, i * nw, j * nh, nw, nh);
                        }
                    }
